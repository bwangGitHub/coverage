...
public abstract class BaseDuration
  ...
  static {
    CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.ping();
  }
  ...
  static {
    CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[1]++;
  }
    ...
    protected BaseDuration(long duration) {
        super();
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[2]++;
        iMillis = duration;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[3]++;
    }
    ...
    protected BaseDuration(long startInstant, long endInstant) {
        super();
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[4]++;
        iMillis = FieldUtils.safeAdd(endInstant, -startInstant);
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[5]++;
    }
    ...
    protected BaseDuration(ReadableInstant start, ReadableInstant end) {
        super();
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[6]++;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[7]++;
int CodeCoverConditionCoverageHelper_C1;
        if ((((((CodeCoverConditionCoverageHelper_C1 = 0) == 0) || true) && (
(((CodeCoverConditionCoverageHelper_C1 |= (2)) == 0 || true) &&
 ((start == end) && 
  ((CodeCoverConditionCoverageHelper_C1 |= (1)) == 0 || true)))
)) && (CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.conditionCounters[1].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C1, 1) || true)) || (CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.conditionCounters[1].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C1, 1) && false)) {
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.branches[1]++;
            iMillis = 0L;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[8]++;

        } else {
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.branches[2]++;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[9]++;
            long startMillis = DateTimeUtils.getInstantMillis(start);
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[10]++;
            long endMillis = DateTimeUtils.getInstantMillis(end);
            iMillis = FieldUtils.safeAdd(endMillis, -startMillis);
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[11]++;
        }
    }
    ...
    protected BaseDuration(Object duration) {
        super();
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[12]++;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[13]++;
        DurationConverter converter = ConverterManager.getInstance().getDurationConverter(duration);
        iMillis = converter.getDurationMillis(duration);
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[14]++;
    }
    ...
    protected void setMillis(long duration) {
        iMillis = duration;
CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01.statements[15]++;
    }
...
class CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01 extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01 ());
  }
  ...
  static {
    final String SECTION_NAME = "org.joda.time.base.BaseDuration.java";
  ...
  public CodeCoverCoverageCounter$ry1x81nrdtfljkh2rw7t8z9i01 () {
    super("org.joda.time.base.BaseDuration.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.joda.time.base.BaseDuration.java");
      for (int i = 1; i <= 15; i++) {
        if (statements[i] != 0L) {
