...
public abstract class DateTimeField {
  static {
    CodeCoverCoverageCounter$5oppigcqxr5kvw4wzo0qecrv1zs1.ping();
  }
...
class CodeCoverCoverageCounter$5oppigcqxr5kvw4wzo0qecrv1zs1 extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$5oppigcqxr5kvw4wzo0qecrv1zs1 ());
  }
    public static long[] statements = new long[0];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$5oppigcqxr5kvw4wzo0qecrv1zs1 () {
    super("org.joda.time.DateTimeField.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.joda.time.DateTimeField.java");
      for (int i = 1; i <= -1; i++) {
        if (statements[i] != 0L) {
