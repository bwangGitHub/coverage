...
public abstract class CompilerTestCase extends TestCase  {
  ...
  protected final Node findQualifiedNameNode(final String name, Node root) {
    ...
    protected CompilerTestCase(String name, int discard) {
    super(name);
    this.externsInputs = ImmutableList.of(
    ...
    protected CompilerTestCase(String name, boolean compare, int discard) {
    super(name);
    this.externsInputs = ImmutableList.of(
        SourceFile.fromCode("externs", ""));
    this.compareAsTree = compare;
    this.parseTypeInfo = false;
  }

    protected CompilerTestCase(String name, String externs, int discard) {
    super(name);
    this.externsInputs = ImmutableList.of(
        SourceFile.fromCode("externs", externs));
    this.compareAsTree = true;
    ...
    protected CompilerTestCase(String name, String externs, boolean compare, int discard) {
    super(name);
    this.externsInputs = ImmutableList.of(
        SourceFile.fromCode("externs", externs));
    this.compareAsTree = compare;
