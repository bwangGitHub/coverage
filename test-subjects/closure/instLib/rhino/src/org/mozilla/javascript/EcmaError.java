...
{
  static {
    CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.ping();
  }

    static final long serialVersionUID = -6261226256957286699L;
  static {
    CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.statements[1]++;
  }
...
CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.statements[2]++;
        this.errorName = errorName;
CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.statements[3]++;
        this.errorMessage = errorMessage;
CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.statements[4]++;
    }
...
CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5.statements[5]++;
    }
...
class CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5 extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5 ());
  }
    public static long[] statements = new long[6];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$iypomt0ag7yuozzgi9f9jbup4aic8pte2bhb5 () {
    super("org.mozilla.javascript.RHINO-SRC-EcmaError.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.mozilla.javascript.RHINO-SRC-EcmaError.java");
      for (int i = 1; i <= 5; i++) {
        if (statements[i] != 0L) {
