...
class CodeCoverCoverageCounter$adralqrs9n89mg8no7vn30aerq2g4t8fhx3wpzhvwqw1ngwx extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$adralqrs9n89mg8no7vn30aerq2g4t8fhx3wpzhvwqw1ngwx ());
  }
    public static long[] statements = new long[0];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$adralqrs9n89mg8no7vn30aerq2g4t8fhx3wpzhvwqw1ngwx () {
    super("org.mozilla.javascript.ast.RHINO-SRC-IdeErrorReporter.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.mozilla.javascript.ast.RHINO-SRC-IdeErrorReporter.java");
      for (int i = 1; i <= -1; i++) {
        if (statements[i] != 0L) {
