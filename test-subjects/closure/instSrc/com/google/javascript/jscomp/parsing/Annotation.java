...
enum Annotation {
  ...
  static final Map<String, Annotation> recognizedAnnotations =
      ...
      build();
  static {
    CodeCoverCoverageCounter$jlzbercapzlrl85wwdo1gm9.statements[1]++;
  }
}

class CodeCoverCoverageCounter$jlzbercapzlrl85wwdo1gm9 extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$jlzbercapzlrl85wwdo1gm9 ());
  }
    public static long[] statements = new long[2];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$jlzbercapzlrl85wwdo1gm9 () {
    super("com.google.javascript.jscomp.parsing.Annotation.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("com.google.javascript.jscomp.parsing.Annotation.java");
      for (int i = 1; i <= 1; i++) {
        if (statements[i] != 0L) {
