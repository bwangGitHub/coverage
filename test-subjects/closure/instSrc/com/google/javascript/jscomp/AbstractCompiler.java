...
public abstract class AbstractCompiler implements SourceExcerptProvider {
  static {
    CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt.ping();
  }

  static final DiagnosticType READ_ERROR = DiagnosticType.error(
      "JSC_READ_ERROR", "Cannot read: {0}");
  static {
    CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt.statements[1]++;
  }

  private LifeCycleStage stage = LifeCycleStage.RAW;
  {
    CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt.statements[2]++;
  }
  ...
  void setLifeCycleStage(LifeCycleStage stage) {
    this.stage = stage;
CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt.statements[3]++;
  }
...
class CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt ());
  }
    public static long[] statements = new long[4];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$1ib8k6g9t1mz1xedns1ic4kk960jnfwpt () {
    super("com.google.javascript.jscomp.AbstractCompiler.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("com.google.javascript.jscomp.AbstractCompiler.java");
      for (int i = 1; i <= 3; i++) {
        if (statements[i] != 0L) {
