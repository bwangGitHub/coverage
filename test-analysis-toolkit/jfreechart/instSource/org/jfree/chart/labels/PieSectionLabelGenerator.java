...
class CodeCoverCoverageCounter$7818ji0op7tr5jgne4lups0uod0cocffmuwiryv309z6p extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$7818ji0op7tr5jgne4lups0uod0cocffmuwiryv309z6p ());
  }
    public static long[] statements = new long[0];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$7818ji0op7tr5jgne4lups0uod0cocffmuwiryv309z6p () {
    super("org.jfree.chart.labels.PieSectionLabelGenerator.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.jfree.chart.labels.PieSectionLabelGenerator.java");
      for (int i = 1; i <= -1; i++) {
        if (statements[i] != 0L) {
