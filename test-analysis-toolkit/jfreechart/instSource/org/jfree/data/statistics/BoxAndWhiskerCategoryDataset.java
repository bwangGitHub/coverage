...
class CodeCoverCoverageCounter$brw54y47zmtl6cbjrp4mpfabzqeum99q99ifikh0pfeq8w2t2zl extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$brw54y47zmtl6cbjrp4mpfabzqeum99q99ifikh0pfeq8w2t2zl ());
  }
    public static long[] statements = new long[0];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$brw54y47zmtl6cbjrp4mpfabzqeum99q99ifikh0pfeq8w2t2zl () {
    super("org.jfree.data.statistics.BoxAndWhiskerCategoryDataset.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.jfree.data.statistics.BoxAndWhiskerCategoryDataset.java");
      for (int i = 1; i <= -1; i++) {
        if (statements[i] != 0L) {
