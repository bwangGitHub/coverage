...
public abstract class DurationField implements Comparable<DurationField> {
  static {
    CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.ping();
  }
...
CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.statements[1]++;
int CodeCoverConditionCoverageHelper_C1;
        if ((((((CodeCoverConditionCoverageHelper_C1 = 0) == 0) || true) && (
(((CodeCoverConditionCoverageHelper_C1 |= (2)) == 0 || true) &&
 ((value == Integer.MIN_VALUE) && 
  ((CodeCoverConditionCoverageHelper_C1 |= (1)) == 0 || true)))
)) && (CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.conditionCounters[1].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C1, 1) || true)) || (CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.conditionCounters[1].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C1, 1) && false)) {
CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.branches[1]++;
            return subtract(instant, (long) value);

        } else {
  CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.branches[2]++;}
...
CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.statements[2]++;
int CodeCoverConditionCoverageHelper_C2;
        if ((((((CodeCoverConditionCoverageHelper_C2 = 0) == 0) || true) && (
(((CodeCoverConditionCoverageHelper_C2 |= (2)) == 0 || true) &&
 ((value == Long.MIN_VALUE) && 
  ((CodeCoverConditionCoverageHelper_C2 |= (1)) == 0 || true)))
)) && (CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.conditionCounters[2].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C2, 1) || true)) || (CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.conditionCounters[2].incrementCounterOfBitMask(CodeCoverConditionCoverageHelper_C2, 1) && false)) {
CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.branches[3]++;
            throw new ArithmeticException("Long.MIN_VALUE cannot be negated");

        } else {
  CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld.branches[4]++;}
        return add(instant, -value);
    }
...
class CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld ());
  }
  ...
  static {
    final String SECTION_NAME = "org.joda.time.DurationField.java";
  ...
  public CodeCoverCoverageCounter$5oy4icl088rq3syfoq8xaq1zkmld () {
    super("org.joda.time.DurationField.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.joda.time.DurationField.java");
      for (int i = 1; i <= 2; i++) {
        if (statements[i] != 0L) {
