...
public abstract class Chronology {
  static {
    CodeCoverCoverageCounter$k7b3a00lrmu4b9tv8ygekbl.ping();
  }
...
class CodeCoverCoverageCounter$k7b3a00lrmu4b9tv8ygekbl extends org.codecover.instrumentation.java.measurement.CounterContainer {

  static {
    org.codecover.instrumentation.java.measurement.ProtocolImpl.getInstance(org.codecover.instrumentation.java.measurement.CoverageResultLogFile.getInstance(null), "fc723371-5766-4804-90bc-1687dd8f2639").addObservedContainer(new CodeCoverCoverageCounter$k7b3a00lrmu4b9tv8ygekbl ());
  }
    public static long[] statements = new long[0];
    public static long[] branches = new long[0];
    public static long[] loops = new long[1];

  public CodeCoverCoverageCounter$k7b3a00lrmu4b9tv8ygekbl () {
    super("org.joda.time.Chronology.java");
  }
  ...
  public void serializeAndReset(org.codecover.instrumentation.measurement.CoverageCounterLog log) {
    log.startNamedSection("org.joda.time.Chronology.java");
      for (int i = 1; i <= -1; i++) {
        if (statements[i] != 0L) {
